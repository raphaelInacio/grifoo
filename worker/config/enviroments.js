...
const enviroments = {
    ...
    emailKey: args.EMAIL_KEY == undefined ? "test" : args.EMAIL_KEY,
    urlPedidos: args.URL_PEDIDOS == undefined ? "http://localhost:3003/api/v1" : args.URL_PEDIDOS,
    urlParceiros: args.URL_PARCEIROS == undefined ? "http://localhost:3004/api/v1" : args.URL_PARCEIROS
}
